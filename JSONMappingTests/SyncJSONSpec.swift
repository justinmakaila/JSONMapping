        ...
        describe("NSManagedObject sync with JSON") {
            ...
            describe ("syncing relationships") {
                it ("can sync with JSON relationships") {
                    ...
                    user.merge(withJSON: json, dateFormatter: dateFormatter)
                ...
                it ("can sync one-way to-one relationships") {
                    ...
                    finn.merge(withJSON: json, dateFormatter: dateFormatter)
            ...
            describe("nil values") {
                it ("overwrites optional properties with nil") {
                    ...
                    finn.merge(withJSON: breakupJSON)
                ...
                it ("will not overwirte non-optional properties with nil") {
                    ...
                    finn.merge(withJSON: invalidJSON, dateFormatter: dateFormatter)
            ...
            describe("subclasses") {
                ...
                it ("can hook into when sync finishes") {
                    ...
                    updatableObject.merge(withJSON: [
                        "state": "completed"
                    ])
